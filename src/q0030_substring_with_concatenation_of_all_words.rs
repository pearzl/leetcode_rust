// q0030_substring_with_concatenation_of_all_words
...
mod tests {
    ...
    fn it_works() {
        ...
        assert_eq!(
            vec![] as Vec<i32>,
            Solution::find_substring("".to_string(), vec![])
        );
        assert_eq!(
            vec![] as Vec<i32>,
        ...
        .map(|x| x.to_string())
        .collect();
        assert_eq!(vec![] as Vec<i32>, Solution::find_substring(s, v));
    }
}
